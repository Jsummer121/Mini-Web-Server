...
class WSGIServer(object):
    ...
    def run_forever(self):
        ...
        while True:
            ...
            new_process = multiprocessing.Process(
                target=self.deal_with_request, args=(new_socket,))
            new_process.start()
            new_socket.close()
        ...
        while True:
            ...
            if not file_name.endswith(".py"):
                ...
                try:
                    ...
                    # 将header返回给浏览器
                    client_socket.send(
                        response_header.encode('utf-8') + response_body)
    ...
    def set_response_headers(self, status, headers):
        ...
        response_header_default = [
            ("Data", time.ctime()), ("Server", "ItCast-python mini web server")]
